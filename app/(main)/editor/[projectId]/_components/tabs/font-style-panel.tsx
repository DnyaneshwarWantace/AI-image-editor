        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-2 gap-3">
            {fontStyles.map((fontStyle) => (
              ...
              >
                <div className="aspect-square bg-gray-100 rounded-lg overflow-hidden border border-gray-200 hover:border-blue-500 transition-colors flex items-center justify-center">
                  {fontStyle.preview ? (
                    <img
