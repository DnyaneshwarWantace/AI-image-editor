      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {!generatedAds ? (
          ...
          <div className="text-center py-20 bg-gray-800 rounded-xl border border-gray-700">
            ...
            <button
              onClick={() => router.push('/ai-ad-generator')}
              className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-6 py-3 rounded-lg font-medium inline-flex items-center gap-2"
            >
              <Sparkles className="h-5 w-5" />
              Generate Ad
            </button>
