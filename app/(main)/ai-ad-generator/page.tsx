      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto mb-8">
          <div className="flex items-center justify-center gap-4">
            <div className={`flex items-center gap-2 ${step === 'fetch' ? 'text-blue-400' : 'text-gray-500'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${step === 'fetch' ? 'bg-blue-600' : 'bg-gray-700'}`}>1</div>
              <span className="font-medium">Fetch Ads</span>
            </div>
            <ArrowRight className="h-5 w-5 text-gray-600" />
            <div className={`flex items-center gap-2 ${step === 'select' ? 'text-blue-400' : 'text-gray-500'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${step === 'select' ? 'bg-blue-600' : 'bg-gray-700'}`}>2</div>
              <span className="font-medium">Select Ads</span>
            </div>
            <ArrowRight className="h-5 w-5 text-gray-600" />
            <div className={`flex items-center gap-2 ${step === 'brand-info' ? 'text-blue-400' : 'text-gray-500'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${step === 'brand-info' ? 'bg-blue-600' : 'bg-gray-700'}`}>3</div>
              <span className="font-medium">Brand Info</span>
            </div>
            <ArrowRight className="h-5 w-5 text-gray-600" />
            <div className={`flex items-center gap-2 ${step === 'generating' ? 'text-blue-400' : 'text-gray-500'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${step === 'generating' ? 'bg-blue-600' : 'bg-gray-700'}`}>4</div>
              ...
              <div className="max-w-2xl">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    disabled={isFetching}
                    className="bg-blue-600 hover:bg-blue-700 disabled:bg-blue-800 text-white px-6 py-3 rounded-lg flex items-center gap-2 font-medium transition-colors"
                  >
                    {isFetching ? (
                      <>
            ...
            <div className="bg-gray-800 rounded-xl p-8 border border-gray-700">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="bg-blue-600 hover:bg-blue-700 disabled:bg-blue-800 text-white px-6 py-3 rounded-lg font-medium flex items-center gap-2"
                >
                  Continue
            ...
            <div className="bg-gray-800 rounded-xl p-8 border border-gray-700">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-6 py-3 rounded-lg font-medium flex items-center gap-2"
                >
          ...
          {step === 'generating' && (
            <div className="bg-gray-800 rounded-xl p-12 border border-gray-700 text-center">
              ...
              <div className="max-w-md mx-auto space-y-2 text-left text-sm text-gray-500">
                ...
                <p className="text-blue-400">→ Creating your ad image...</p>
              </div>
            </div>
          )}
